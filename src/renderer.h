...
void renderer_draw(struct raycaster_renderer *renderer, const int *const map, int map_width, int map_height, double camera_x, double camera_y, double camera_r);
